...
class MakeInvoice(models.Model):
    _name = 'servicio.consolidado.factura'
    ...
    def show_service_lines(self):
        ...
        ids_guardadas = []
        if self.camion_id.productos_servicios_camion_ids:
            ids_guardadas = self.camion_id.productos_servicios_camion_ids.ids
    ...
    def create_invoices(self):
        ...
        # if self.advance_payment_method == 'percentage' and self.tramo_a_facturar == 'national':
        #     if camion.state == 'progress_international':
        #         camion.state = 'progress'
        #     else:
        #         camion.state = 'progress_national'
        # if self.advance_payment_method == 'percentage' and self.tramo_a_facturar == 'internacional':
        #     if camion.state == 'progress_national':
        #         camion.state = 'progress'
        #     else:
        #         camion.state = 'progress_international'
        if self.advance_payment_method == 'all':
            camion.state = 'progress'
        else:
